...
if [ "$SHOULD_CHECK" = true ]; then
    ...
    echo "│ This session is getting deep. Consider wrapping up"
    echo "│ soon. If there are unsaved learnings, decisions, or"
    echo "│ conventions, now is a good time to persist them."
    echo "└──────────────────────────────────────────────────"
    echo ""
