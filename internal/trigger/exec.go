...
// runOne executes a single hook script, enforcing the given timeout.
// It writes inputJSON to the script's stdin and reads HookOutput JSON
// from stdout. Returns an error for non-zero exit, timeout, or
// invalid JSON output.
func runOne(
