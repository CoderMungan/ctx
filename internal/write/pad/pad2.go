...
func PadEmpty(cmd *cobra.Command) {
	...
	cmd.Println(assets.TextDesc(assets.TextDescKeyWritePadEmpty))
}
...
func PadKeyCreated(cmd *cobra.Command, path string) {
	...
	cmd.PrintErrln(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadKeyCreated), path))
}
...
func PadEntryAdded(cmd *cobra.Command, n int) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadEntryAdded), n))
}
...
func PadEntryUpdated(cmd *cobra.Command, n int) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadEntryUpdated), n))
}
...
func PadExportPlan(cmd *cobra.Command, label, outPath string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadExportPlan), label, outPath))
}
...
func PadExportDone(cmd *cobra.Command, label string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadExportDone), label))
}
...
func ErrPadExportWrite(cmd *cobra.Command, label string, cause error) {
	...
	cmd.PrintErrln(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadExportWriteFailed), label, cause))
}
...
func PadBlobWritten(cmd *cobra.Command, size int, path string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadBlobWritten), size, path))
}
...
func PadEntryRemoved(cmd *cobra.Command, n int) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadEntryRemoved), n))
}
...
func PadResolveSide(cmd *cobra.Command, side string, entries []string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadResolveHeader), side))
	for i, entry := range entries {
		cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadResolveEntry), i+1, entry))
	}
}
...
func PadEntryMoved(cmd *cobra.Command, from, to int) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadEntryMoved), from, to))
}
...
func PadImportNone(cmd *cobra.Command) {
	...
	cmd.Println(assets.TextDesc(assets.TextDescKeyWritePadImportNone))
}
...
func PadImportDone(cmd *cobra.Command, count int) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadImportDone), count))
}
...
func PadImportBlobAdded(cmd *cobra.Command, name string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadImportBlobAdded), name))
}
...
func ErrPadImportBlobSkipped(cmd *cobra.Command, name string, cause error) {
	...
	cmd.PrintErrln(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadImportBlobSkipped), name, cause))
}
...
func ErrPadImportBlobTooLarge(cmd *cobra.Command, name string, max int) {
	...
	cmd.PrintErrln(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadImportBlobTooLarge), name, max))
}
...
func PadImportBlobSummary(cmd *cobra.Command, added, skipped int) {
	...
	if added == 0 && skipped == 0 {
		cmd.Println(assets.TextDesc(assets.TextDescKeyWritePadImportBlobNone))
		return
	}
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadImportBlobSummary), added, skipped))
}
...
func ErrPadImportCloseWarning(cmd *cobra.Command, name string, cause error) {
	...
	cmd.PrintErrln(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadImportCloseWarning), name, cause))
}
...
func PadMergeDupe(cmd *cobra.Command, display string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadMergeDupe), display))
}
...
func PadMergeAdded(cmd *cobra.Command, display, file string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadMergeAdded), display, file))
}
...
func PadMergeBlobConflict(cmd *cobra.Command, label string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadMergeBlobConflict), label))
}
...
func PadMergeBinaryWarning(cmd *cobra.Command, file string) {
	...
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadMergeBinaryWarning), file))
}
...
func PadMergeSummary(cmd *cobra.Command, added, dupes int, dryRun bool) {
	...
	if added == 0 && dupes == 0 {
		cmd.Println(assets.TextDesc(assets.TextDescKeyWritePadMergeNone))
		return
	}
	if added == 0 {
		cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadMergeNoneNew), dupes, padPluralize("duplicate", dupes)))
		return
	}
	if dryRun {
		cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadMergeDryRun),
			added, padPluralize("entry", added),
			dupes, padPluralize("duplicate", dupes)))
		return
	}
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadMergeDone),
		added, padPluralize("entry", added),
		dupes, padPluralize("duplicate", dupes)))
}
...
func PadExportSummary(cmd *cobra.Command, count int, dryRun bool) {
	...
	if count == 0 {
		cmd.Println(assets.TextDesc(assets.TextDescKeyWritePadExportNone))
		return
	}
	verb := assets.TextDesc(assets.TextDescKeyWritePadExportVerbDone)
	if dryRun {
		verb = assets.TextDesc(assets.TextDescKeyWritePadExportVerbDryRun)
	}
	cmd.Println(fmt.Sprintf(assets.TextDesc(assets.TextDescKeyWritePadExportSummary), verb, count))
}
