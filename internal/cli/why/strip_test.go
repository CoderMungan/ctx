...
func TestMkDocs_Frontmatter(t *testing.T) {
	input := "---\ntitle: Test\nicon: lucide/flame\n---\n\n# Hello\n"
	got := strip.MkDocs(input)
...
func TestMkDocs_Images(t *testing.T) {
...
func TestMkDocs_Admonitions(t *testing.T) {
...
func TestMkDocs_AdmonitionNoTitle(t *testing.T) {
	input := "!!! warning\n    Body here.\n"
	got := strip.MkDocs(input)
...
func TestMkDocs_Tabs(t *testing.T) {
	input := `=== "Without ctx"
...
func TestMkDocs_RelativeLinks(t *testing.T) {
...
func TestMkDocs_PreservesExternalLinks(t *testing.T) {
...
func TestMkDocs_PreservesCodeBlocks(t *testing.T) {
	input := "```text\n{} --> what\nctx --> why\n```\n"
	got := strip.MkDocs(input)
