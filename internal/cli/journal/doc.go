...
//
// The journal system provides two output formats from
...
//
// Both formats reuse the same scan/parse/index infrastructure
// and consume the same enriched journal entries (YAML frontmatter
// with topics, type, outcome, technologies, key_files).
package journal
