...
Measured by calendar time, it is nothing. Measured by what changed in how the 
project operates, it is the most significant release yet.

* `v0.1.0` was the prototype;
* `v0.2.0` was the [archaeology release][v020]:
   making the past accessible; 
* `v0.3.0` is the **discipline release**: the one that turned best practices 
   into **enforcement**, suggestions into **structure**, and a collection of 
   commands into a **system of skills**.
...
What matters for the release story is the **result**: 
...
!!! tip "The Skill Trilogy as Design Spec"
    ...
    * [Skills That Fight the Platform][fight], 
    * [You Can't Import Expertise][import],
    * and [The Anatomy of a Skill That Works][anatomy]...

    ... were not retrospective documentation. They were written 
    **during** the rewrite, and the lessons fed back into the skills 
...
[3:1 ratio][ratio] that emerged during `v0.2.0` development became an
explicit practice: 
...
[ear-post]: 2026-02-05-you-cant-import-expertise.md

## The E/A/R Framework

On February 4th, we adopted the [**E/A/R classification**][ear-post] as the
...
If more than 10% of a skill restates platform defaults, it is creating noise,
not signal.
...
resilient. The **[consolidation](2026-02-17-the-3-1-ratio.md)** 
practice is documented and repeatable.

The next chapter is about what you build **on top of** discipline:

* Multi-agent coordination;
* Deeper integration patterns; 
* And the question of whether context management is a *tool concern* or 
