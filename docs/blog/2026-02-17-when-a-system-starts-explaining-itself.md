...
The [attention budget][attention-post] explained why context degrades:
...
[IRC bouncers][irc-post] solved this for chat twenty years ago.  
...
!!! tip "This Is the Two-Tier Model in Practice"
    The [two-tier persistence model][infra-post]
...
The [merge debt post][merge-debt-post] reached the same conclusion from 
another direction:
...
This post is the **field repor**t from the **other side** of that bottleneck:
