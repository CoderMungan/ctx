...
new capabilities, visible progress...

...but after three of them, things would start to feel *sticky*: variable
names that almost made sense, files that had grown past their purpose,
patterns that repeated without being formalized.

The **fourth session** (*when I stopped adding and started cleaning*)
was always the most **painful** to start and the most **satisfying** to finish.
...
!!! warning "The Compounding Problem"
    **Consolidation debt compounds**.
    ...
    Week one's drift doesn't just persist
...
if I ever need to change the default (*and I did, for hook scripts
...
!!! info "The Consolidation Paradox"
    ...
    **The 3:1 ratio** resolves this paradox:
    ...
    Let drift accumulate for three sessions (*enough to see patterns*),
    then **consolidate* in the fourth (*before the patterns become entrenched*).

---

## The Consolidation Skill

The `ctx` project now has an `/audit` skill that encodes nine
...
Consolidation is about **reducing maintenance cost**, not achieving aesthetic 
perfection. Code that works and exists in one place does not benefit 
from consolidation; it benefits from being left alone until it earns its
refactoring.
...
It moves completed work to **cold storage**, keeping the active context clean
